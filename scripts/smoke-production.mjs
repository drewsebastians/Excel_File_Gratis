...
const draftSlugs = [
  ...
  "panduan-audit-rumus-excel", "panduan-checklist-kualitas-file-excel", "panduan-conditional-formatting-sebagai-alarm", "panduan-data-model-excel", "panduan-dropdown-dinamis-excel", "panduan-dynamic-array-spill-excel", "panduan-excel-table-vs-range", "panduan-parameter-power-query", "panduan-pivottable-dua-tabel", "panduan-power-query-append", "panduan-power-query-data-asli", "panduan-power-query-merge-vs-append", "panduan-power-query-unpivot", "panduan-rumus-filter-laporan", "panduan-rumus-let-excel", "panduan-sparklines-excel", "panduan-structured-references-excel-table", "panduan-textsplit-excel", "panduan-unique-sort-excel", "panduan-validasi-data-formula-kustom",
];
...
record("sitemap:xml-content", `${baseUrl}/sitemap.xml`, /<urlset[\s>]/i.test(sitemap) && !sitemap.includes("panduan-audit-rumus-excel") && !sitemap.includes("template-checklist-acara"), "XML sitemap excludes draft slugs", { draftLeak: draftSlugs.filter((slug) => sitemap.includes(slug)) });
